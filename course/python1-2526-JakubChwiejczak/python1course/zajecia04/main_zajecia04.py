from python1course.zajecia04.fleet.ambulance import Ambulance
from python1course.zajecia04.operations import *
from python1course.zajecia04.personnel import *
